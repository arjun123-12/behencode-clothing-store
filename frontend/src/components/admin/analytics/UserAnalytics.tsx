...
export const UserAnalytics: React.FC = () => {
  return (
    <div className="bg-background border border-border-custom/30 p-6 rounded-3xl space-y-4 text-left select-none shadow-sm hover:shadow-md transition-all duration-300 animate-fadeIn">
      ...
      <div>
        <span className="block text-[10px] font-bold text-light-brown uppercase tracking-wider">Storefront Signups</span>
        <h3 className="font-playfair text-2xl font-bold text-foreground mt-1">342 Accounts</h3>
        <p className="text-[10px] text-light-brown mt-1.5 leading-relaxed">
          Measure customer acquisition rates and backoffice session statistics.
        </p>
      </div>
      ...
      <div className="pt-2 flex items-end gap-2.5 h-16 w-full">
        ...
        <div className="bg-rose/20 rounded-md flex-1 h-[65%]" />
        <div className="bg-rose/25 rounded-md flex-1 h-[80%]" />
        <div className="bg-rose rounded-md flex-1 h-[95%]" />
      </div>
    </div>
  );
};
